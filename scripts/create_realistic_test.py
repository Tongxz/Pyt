...
def test_with_realistic_image():
    ...
    ax = plt.gca()
    # 人体1
    rect1 = Rectangle((150, 150), 100, 400, linewidth=2, edgecolor='red', facecolor='none')
    ax.add_patch(rect1)
    plt.text(200, 140, 'Person 1\n(Blue Hairnet)', ha='center', va='bottom', 
             bbox=dict(boxstyle='round', facecolor='lightblue', alpha=0.7))
    
    # 人体2
    rect2 = Rectangle((350, 140), 100, 420, linewidth=2, edgecolor='red', facecolor='none')
    ax.add_patch(rect2)
    plt.text(400, 130, 'Person 2\n(White Hairnet)', ha='center', va='bottom',
             bbox=dict(boxstyle='round', facecolor='lightgray', alpha=0.7))
    
    # 人体3
    rect3 = Rectangle((550, 160), 100, 410, linewidth=2, edgecolor='red', facecolor='none')
    ax.add_patch(rect3)
    plt.text(600, 150, 'Person 3\n(No Hairnet)', ha='center', va='bottom',
...
if __name__ == '__main__':
    ...
    print(f"\n测试图像已创建: {image_path}")
    print("\n现在可以使用以下命令测试ROI可视化:")
    print(f"python visualize_roi.py --image {image_path} --save realistic_roi_analysis.png")