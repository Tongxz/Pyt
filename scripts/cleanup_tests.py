...
def main():
    ...
    # 打印统计信息
    print("\n清理完成!")
    print(f"测试文件: 删除={deleted_files_count}, 跳过={skipped_files_count}, 错误={error_files_count}")
    print(f"测试图像: 删除={deleted_images_count}, 跳过={skipped_images_count}, 错误={error_images_count}")
    print(f"脚本文件: 移动={moved_scripts_count}, 跳过={skipped_scripts_count}, 错误={error_scripts_count}")
    print(f"数据文件: 移动={moved_data_count}, 跳过={skipped_data_count}, 错误={error_data_count}")
    print(f"总计: 处理={deleted_files_count + deleted_images_count + moved_scripts_count + moved_data_count}, "
