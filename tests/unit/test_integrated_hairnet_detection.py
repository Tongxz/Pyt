...
try:
    ...
    from src.core.hairnet_detector import HairnetDetector, HairnetDetectionPipeline
...
def test_roi_comparison():
    ...
    try:
        ...
        if hairnet_detector.use_enhanced_roi:
            ...
            if enhanced_result:
                print(f"增强ROI: {enhanced_result['strategy']}, 质量: {enhanced_result.get('quality_score', 0):.3f}")
            else:
                print("增强ROI提取失败")
