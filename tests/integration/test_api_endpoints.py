...
class TestAPIEndpoints(unittest.TestCase):
    ...
    def test_detect_image_endpoint(self):
        ...
        data = {"confidence_threshold": 0.5, "visualize": True}
    ...
    def test_detect_hairnet_endpoint(self):
        ...
        files = {"file": ("test.jpg", test_image, "image/jpeg")}
        data = {"confidence_threshold": 0.7, "visualize": True}
    ...
    def test_detect_video_endpoint(self):
        ...
        data = {"confidence_threshold": 0.5, "frame_skip": 5}
    ...
    def test_statistics_realtime_endpoint(self):
        ...
        response = requests.get(
            f"{self.base_url}/api/statistics/realtime", timeout=self.timeout
        )
    ...
    def test_statistics_with_date_range(self):
        ...
        response = requests.get(
            f"{self.base_url}/api/statistics", params=params, timeout=self.timeout
        )
    ...
    def test_invalid_image_upload(self):
        ...
        response = requests.post(
            f"{self.base_url}/api/v1/detect/image", files=files, timeout=self.timeout
        )
    ...
    def test_missing_file_upload(self):
        """测试缺少文件的上传请求"""
        response = requests.post(
            f"{self.base_url}/api/v1/detect/image", timeout=self.timeout
        )
    ...
    def test_error_handling(self):
        ...
        # 访问不存在的端点
        response = requests.get(
            f"{self.base_url}/api/nonexistent", timeout=self.timeout
        )
