...
def test_human_detection_detailed():
    ...
    for config in test_configs:
        print(f"\n=== 测试 {config['name']} ===")
        print(f"置信度阈值: {config['conf']}, 最小面积: {config['min_area']}, 最大宽高比: {config['max_ratio']}")
        ...
        try:
            ...
            for i, det in enumerate(detections):
                ...
                print(f"  人员 {i+1}: 位置=({bbox[0]}, {bbox[1]}, {bbox[2]}, {bbox[3]}), "
            ...
            if boxes is not None:
                ...
                for box in boxes:
                    ...
                    if class_id == 0:  # person class
                        ...
                        height = y2 - y1
                        area = width * height
                        print(f"    人员: 位置=({x1:.0f}, {y1:.0f}, {x2:.0f}, {y2:.0f}), "
