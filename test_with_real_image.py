...
def test_comprehensive_detection_with_person():
    ...
    # 准备文件数据
    files = {
        'file': ('test_person.jpg', buffer.tobytes(), 'image/jpeg')
    }
    ...
    try:
        ...
        if response.status_code == 200:
            ...
            for i, detection in enumerate(detections):
                print(f"   {i+1}. 类别: {detection.get('class', 'unknown')}, "
            ...
            if result.get('annotated_image'):
                ...
                try:
                    ...
                    with open('/Users/zhou/Code/python/Pyt/test_annotated_result.jpg', 'wb') as f:
                        f.write(img_data)
