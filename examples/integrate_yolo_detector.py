...
def parse_args():
    ...
    parser.add_argument('--image', type=str, required=True,
                        help='输入图像路径')
    parser.add_argument('--detector-type', type=str, default='yolo',
                        choices=['auto', 'yolo'],
                        help='检测器类型，可选 auto, yolo，默认为 yolo')
    parser.add_argument('--model', type=str, default='models/hairnet_detection.pt',
