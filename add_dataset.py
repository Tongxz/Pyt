...
class DatasetExpander:
    ...
    def add_images_and_labels(self, source_images_dir: str, source_labels_dir: str, 
                             target_split: str = "train") -> bool:
        """
        添加图片和标注文件到指定的数据集分割
    ...
    def convert_labelme_to_yolo(self, labelme_json_dir: str, output_labels_dir: str) -> bool:
        """
...
def main():
    ...
    while True:
        ...
        if choice == '1':
            ...
            success = expander.add_images_and_labels(images_dir, labels_dir, split_choice)
            if success:
                print("\n数据添加成功！")
                expander.print_statistics()
            else:
