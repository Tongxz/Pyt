...
def create_test_image_with_person(width=800, height=600):
    ...
    head_radius = 40
    draw.ellipse(
        [center_x - head_radius, center_y - 150, center_x + head_radius, center_y - 70],
        fill="lightblue",
        outline="black",
        width=2,
    )
    ...
    draw.line(
        [
            center_x - body_width // 2,
            center_y - 40,
            center_x - body_width // 2 - arm_length,
            center_y,
        ],
        fill="brown",
        width=8,
    ...
    # 左腿
    draw.line(
        [center_x - 20, center_y + 50, center_x - 20, center_y + 50 + leg_length],
        fill="blue",
        width=12,
    )
    # 右腿
